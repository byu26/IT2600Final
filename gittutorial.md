...
##### For more Git commands see [this](https://github.com/joshnh/Git-Commands) link.[^1]
[^1]: These are only some commonly used commands. Make sure to look up other commands as you see fit. 
---
